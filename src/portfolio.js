import file from './files/prabal-raj-resume-final.pdf';
const header = {
...
const about = {
  ...
  description: '3+ years of experience in React JS and front-end development. Proficient in designing user interfaces and building dynamic web apps. Skilled in HTML, CSS, JavaScript, and React libraries. Strong debugging and optimization skills, focused on delivering top-notch user experiences.',
  resume: file,
  social: {
